        ...
        <div className="row justify-content-center">
          <div className="w-[78vw] flex h-[80vh] relative">
            ...
            <div id="obj2" className="w-1/2 h-full content-start font-mono">
              ...
              <div className="mt-8 leading-loose"><h3 className="title text-xl">Welcome to Performance Vision Eye Care. <br/>Located at 1242 Burrard St, Vancouver, BC. <br />
        ...
        <div className="row justify-content-center">
          <div className="w-full flex flex-col h-[80vh] ">
            ...
            <div id="obj2" className="w-full h-full p-4 content-start font-mono">
              ...
              <div className="mt-8 leading-loose"><h3 className="title ">Welcome to performance vision eye care, located at 1242 Burrard st,Vancouver, BC. <br />
