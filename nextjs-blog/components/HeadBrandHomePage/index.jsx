  ...
  return (
    <div className="container md:pt-8">
      <div className="row justify-content-center">
        ...
        <div className="h-64 w-[78vw] bg-black h-64 relative hidden md:block">
          <div id="obj1" className="flex">
          ...
          <div id="obj2" className="flex absolute top-0 left-0 w-full h-full">
            ...
            <div className="w-3/5 h-full flex items-center justify-center relative z-10">
              <div className="flex w-full h-full flex-col">
                <div className="h-3/5 mt-4 mr-2 text-left text-xl font-mono text-white"><span className="font-bold">Hermosa & Despada - </span> Luxury eyeglasses and luxury sunglasses made in Europe. Exclusive in Performance Vision Eye Care.</div>
          ...
          <div id="obj1" className="flex flex-col">
            ...
            <div className="w-full h-56 flex items-center justify-center relative z-0">
              ...
              <div className="absolute top-0 left-0 w-full h-full">
                <div className="h-3/5 mt-2 mx-2 text-left text-xl font-mono text-white"><span className="font-bold">Hermosa & Despada - </span> Luxury eyeglasses and luxury sunglasses made in Europe. Exclusive in Performance Vision Eye Care.</div>
