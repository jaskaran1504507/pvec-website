          ...
          <div id="obj1" className="flex flex-col">
            ...
            <div className="w-full h-56 flex items-center justify-center relative z-0">
              ...
              <div className="absolute top-0 left-0 w-full h-full">
                <div className="h-3/5 mt-2 mx-2 text-left text-xl font-mono text-white"><span className="font-bold">Hermosa & Despada - </span> Luxury eyeglasses and luxury sunglasses made in Europe. Exclusive to Performance Vision Eye Care.</div>
