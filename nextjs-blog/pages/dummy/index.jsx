...
export default function GlassesContacts() { return (
//   <!DOCTYPE html>
              ...
              <div className="row no-gutters">
                  ...
                  >
                    <div className="counter-items text-center">
                      <span className="count"
                        ><span className="counter">125</span>K</span
                      >
                ...
                <div className="col-4">
                  ...
                  >
                    <div className="counter-items text-center">
                      <span className="count"
                        ><span className="counter">87</span>K</span
                      >
                ...
                <div className="col-4">
                  ...
                  >
                    <div className="counter-items text-center">
                      <span className="count"
                        ><span className="counter">4.8</span></span
                      >
