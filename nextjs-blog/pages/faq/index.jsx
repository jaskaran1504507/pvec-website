      ...
      <div id="q1" className="container mt-2">
        <div className="divide-y">
          ...
          <div id="q2" className="mt-12">
            <h2 className="mt-2 text-3xl font-bold">2. What age should I get my child’s eye exams done?</h2>
            <div className="ml-6">
          ...
          <div id="q4" className="mt-12">
            <h2 className="mt-2 text-3xl font-bold">4. Are sunglasses just for fashion or are they necessary?</h2>
            <div className="ml-6">
          ...
          <div className="mt-12" id="q5">
            <h2 className="text-3xl font-bold">5. Why Buy Contact Lenses In-Store vs Online?</h2>
            <div className="ml-6">
              <ul>
                <li className="text-2xl">&#x2022; Price Match with any Competitor</li>
                {/* <li className="text-2xl">&#x2022; Nearly 1000 Frames on hand to try</li> */}
                <li className="text-2xl">&#x2022; Rebates up to $200 not available online</li>
          ...
          <div id="q6" className="mt-12">
            <h2 className="mt-2 text-3xl font-bold">6. How can I reduce eye strain and redness from working on computer screens including my tablet and phone all day?</h2>
            <div className="ml-6 ">
